namespace Tempt
{
    ...
    public sealed class ErosionSystemt
    {
        ...
        public ErosionSystemt(ErosionStateModelt model, EventBust events)
        {
            Model = model;
            Events = events;
        }
        ...
        public void AdvanceDay(int currentDay)
        {
            ...
            //TODO: float increment = BalanceDatat.ErosionDailyIncrement * UnityEngine.Mathf.Pow(BalanceDatat.ErosionExponent, s - 1);
            ...
            BalanceDatat balance = GameSystemManagert.TryGetInstance(out GameSystemManagert gsm) ? gsm.Data?.Balance : null; //Wave0write
        ...
        public void OnBossRecleared(int stageIndex)
        {
            ...
            if (GameSystemManagert.TryGetInstance(out GameSystemManagert gsm) && gsm.CurrentRun?.SafeUnlocks != null) //Wave0write
            { //Wave0write
        ...
        public float ComputeMonsterMultiplier(int stageIndex)
        {
            ...
            //TODO: return rate > 0f ? BalanceDatat.ErosionMonsterMultiplier : 1f;
            ...
            if (GameSystemManagert.TryGetInstance(out GameSystemManagert gsm) && gsm.Data?.Balance != null) //Wave0write
            { //Wave0write
