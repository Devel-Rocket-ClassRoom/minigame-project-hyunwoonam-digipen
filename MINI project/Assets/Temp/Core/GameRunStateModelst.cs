...
namespace Tempt
{
    ...
    public sealed class CompanionRosterStatet
    {
        ...
        public bool Promote(int companionId)
        {
            ...
            CompanionInstancet inst = Bench.Find(c => c.CompanionDataId == companionId); //Wave0write
            if (inst == null) //Wave0write
            { //Wave0write
                return false; //Wave0write
            } //Wave0write
        ...
        public bool Demote(int companionId)
        {
            ...
            //TODO: Bench.Add(inst);
            //TODO: return true;
            CompanionInstancet inst = Active.Find(c => c.CompanionDataId == companionId); //Wave0write
            if (inst == null) //Wave0write
            { //Wave0write
                return false; //Wave0write
            } //Wave0write
