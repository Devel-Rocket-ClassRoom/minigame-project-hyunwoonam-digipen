namespace Tempt
{
    ...
    public abstract class SafeZoneControllerBaset : SceneControllerBaset
    {
        ...
        public override void OnEnter()
        {
            ...
            //TODO: var gsm = GameSystemManagert.Instance;
            ...
            GameRunStatet run = gsm.CurrentRun; //Wave0write
        ...
        public void DepartToFloorMap()
        {
            ...
            //TODO: GameSystemManagert.Instance.Scenes.LoadFloorMap();
            GameSystemManagert.Instance.Scenes.LoadFloorMap(); //Wave0write
        }
    }
}
