...
namespace Tempt
{
    ...
    /// </summary>
    public sealed class WorldDatat
    {
        /// <summary>단계 정의(1~6).</summary>
        public List<StageDeft> Stages;

        /// <summary>안전지대 정의(0~5).</summary>
        public List<SafeZoneDeft> SafeZones;

        /// <summary>플로어 맵 생성 규칙.</summary>
        public FloorGenRulet FloorGen;
    ...
    public sealed class SafeZoneDeft
    {
    ...
    /// <summary>플로어 맵 생성 규칙.</summary>
    public sealed class FloorGenRulet
    {
