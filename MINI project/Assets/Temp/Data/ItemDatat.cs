namespace Tempt
{
    ...
    public sealed class ItemDatat : DataTablet
    {
        ...
        /// enum이 아니라 CSV 문자열로 유지하되 DataManagert 검증 단계에서 허용값을 검사한다.
        /// </summary>
        ...
        public override void Parse(string[] cells)
        {
            ...
            // - cells[0] = ItemID → Id
            // - cells[1] = NameKey
            // - cells[2] = Category (enum 문자열 → ItemCategoryt)
            ...
            //TODO: Category     = (ItemCategoryt)System.Enum.Parse(typeof(ItemCategoryt), cells[2]);
            ...
            //TODO: Stackable = (Category == ItemCategoryt.Consumable || Category == ItemCategoryt.Material);
