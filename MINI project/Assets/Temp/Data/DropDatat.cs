...
namespace Tempt
{
    ...
    /// </summary>
    public sealed class DropEntryt : DataTablet
    {
        /// <summary>드랍 그룹 식별자(MonsterDatat.DropTableId와 매핑).</summary>
    ...
    /// <summary>
    /// 드랍 해결 결과 단위. DataManagert.ResolveDrops() 반환 원소.
    /// </summary>
    public sealed class DroppedItemStackt
    {
