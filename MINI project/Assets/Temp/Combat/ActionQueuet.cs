...
namespace Tempt
{
    ...
    public sealed class ActionQueuet
    {
        ...
        public void BuildRound(IEnumerable<EntityBaset> participants)
        {
            ...
            //TODO: foreach (EntityBaset entity in participants)
            //TODO: {
            //TODO:     if (entity.IsDead) continue;
            //TODO:     int score = entity.Stats.SPD + WeightedRandomt.Sample(-RandomRange, RandomRange);
            //TODO:     Entries.Add(new TurnEntryt { Actor = entity, Score = score });
            //TODO: }
            ...
            foreach (EntityBaset entity in participants) //Wave0write
            { //Wave0write
                ...
                Entries.Add(new TurnEntryt { Actor = entity, Score = entity.Stats.SPD + WeightedRandomt.Sample(-randomRange, randomRange) }); //Wave0write
            } //Wave0write
