...
namespace Tempt
{
    ...
    public sealed class NewGameConfirmPopupt
    {
        ...
        public void Show()
        {
            ...
            // - 아니요 → 팝업 닫기.
            //TODO: string msg = LanguageServicet.Get("main.confirm_new_game");
            //TODO: GameSystemManagert.Instance.UI.OpenPage(ConfirmPage);
            //TODO: ConfirmPage.SetMessage(msg);
            //TODO: ConfirmPage.OnYes = () =>
            //TODO: {
            //TODO:     GameSystemManagert.Instance.Save.ClearContinue();
            //TODO:     OnConfirmed?.Invoke();
            //TODO:     GameSystemManagert.Instance.UI.CloseTopPage();
            //TODO: };
            //TODO: ConfirmPage.OnNo = () => GameSystemManagert.Instance.UI.CloseTopPage();
        }
    }
}
