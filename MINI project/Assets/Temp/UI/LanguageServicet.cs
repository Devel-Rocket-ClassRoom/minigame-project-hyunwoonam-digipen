...
namespace Tempt
{
    ...
    public sealed class LanguageServicet
    {
        ...
        public void Change(string lang)
        {
            ...
            //TODO: if (!Data.Languages.Contains(lang)) return;
            //TODO: Current = lang;
            //TODO: Events.RaiseLanguageChanged(lang);
        }
        ...
        public string Get(string key)
        {
            ...
            //TODO: return Data.Get(key, Current);
            return string.Empty;
        }
        ...
        public string Get(string key, params object[] args)
        {
            ...
            //TODO: return string.Format(Data.Get(key, Current), args);
            return string.Empty;
        }
    }
}
