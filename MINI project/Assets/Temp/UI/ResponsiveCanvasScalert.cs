...
namespace Tempt
{
    ...
    public sealed class ResponsiveCanvasScalert : MonoBehaviour
    {
        ...
        public void Apply()
        {
            ...
            //TODO: var scaler = GetComponent<UnityEngine.UI.CanvasScaler>();
            //TODO: scaler.uiScaleMode = UnityEngine.UI.CanvasScaler.ScaleMode.ScaleWithScreenSize;
            //TODO: scaler.referenceResolution = ReferenceResolution;
            //TODO: scaler.matchWidthOrHeight = 0.5f;
        }
    }
}
