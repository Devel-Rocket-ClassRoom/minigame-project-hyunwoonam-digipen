...
namespace Tempt
{
    ...
    public sealed class PlayerRuneStatet
    {
        ...
        public bool TryUnlock(int nodeId)
        {
            ...
            if (!Tree.AllNodes.TryGetValue(nodeId, out RuneNodet node) || node.Unlocked || !Tree.CanUnlock(node)) //Wave0write
            { //Wave0write
                return false; //Wave0write
            } //Wave0write
        ...
        public void ResetTree()
        {
            ...
            //TODO: RunePoints += UnityEngine.Mathf.RoundToInt(refundable * BalanceDatat.RuneResetRefundRate);
            //TODO: // 모든 노드 잠금
            ...
            { //Wave0write
                foreach (RuneNodet node in Tree.AllNodes.Values) //Wave0write
                { //Wave0write
        ...
        public EquipmentStatModt AggregateStatMod()
        {
            ...
            //TODO:     {
            //TODO:         case RuneEffectTypet.AddMaxHP:  result.HP  += (int)node.Data.EffectValue; break;
            //TODO:         case RuneEffectTypet.AddMaxMP:  result.MP  += (int)node.Data.EffectValue; break;
            //TODO:         case RuneEffectTypet.AddATK:    result.ATK += (int)node.Data.EffectValue; break;
            //TODO:         case RuneEffectTypet.AddDEF:    result.DEF += (int)node.Data.EffectValue; break;
            //TODO:         case RuneEffectTypet.AddSPD:    result.SPD += (int)node.Data.EffectValue; break;
            ...
            { //Wave0write
                if (!Tree.AllNodes.TryGetValue(id, out RuneNodet node) || node.Data == null) //Wave0write
                { //Wave0write
                    continue; //Wave0write
                } //Wave0write
        ...
        private static void AddRuneMod(EquipmentStatModt target, RuneDatat data) //Wave0write
        { //Wave0write
            int value = (int)data.EffectValue; //Wave0write
            switch (data.EffectType) //Wave0write
            { //Wave0write
                case RuneEffectTypet.AddMaxHP: target.HP += value; break; //Wave0write
                case RuneEffectTypet.AddMaxMP: target.MP += value; break; //Wave0write
                case RuneEffectTypet.AddATK: target.ATK += value; break; //Wave0write
                case RuneEffectTypet.AddDEF: target.DEF += value; break; //Wave0write
                case RuneEffectTypet.AddSPD: target.SPD += value; break; //Wave0write
            } //Wave0write
        } //Wave0write
    }
}
