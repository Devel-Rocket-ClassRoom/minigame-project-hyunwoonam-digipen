...
namespace Tempt
{
    ...
    public sealed class CompanionRuneStatet
    {
        ...
        public void UnlockStarter()
        {
            ...
            if (Tree?.AllNodes != null && Tree.AllNodes.TryGetValue(FixedSequence[0], out RuneNodet starter)) //Wave0write
            { //Wave0write
        ...
        public bool UnlockNextNodeIfPossible()
        {
            ...
            if (Tree?.AllNodes != null && Tree.AllNodes.TryGetValue(nextId, out RuneNodet node)) //Wave0write
            { //Wave0write
        ...
        public EquipmentStatModt AggregateStatMod()
        {
            ...
            { //Wave0write
                if (!Tree.AllNodes.TryGetValue(FixedSequence[i], out RuneNodet node) || node.Data == null) //Wave0write
                { //Wave0write
                    continue; //Wave0write
                } //Wave0write
                ...
                { //Wave0write
                    case RuneEffectTypet.AddMaxHP: result.HP += value; break; //Wave0write
                    case RuneEffectTypet.AddMaxMP: result.MP += value; break; //Wave0write
                    case RuneEffectTypet.AddATK: result.ATK += value; break; //Wave0write
                    case RuneEffectTypet.AddDEF: result.DEF += value; break; //Wave0write
                    case RuneEffectTypet.AddSPD: result.SPD += value; break; //Wave0write
                } //Wave0write
            } //Wave0write
